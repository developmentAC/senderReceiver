...
def sender(remoteIP_str):
    ''' text sending function'''
    #print("\t Remote IP is: ",remoteIP_str)
    myHost_str = getMyIP() # "192.168.1.14"
    host = remoteIP_str # "192.168.1.28" # the IP address of target computer
    #port = 13000
    addr = (host, port)
...
def senderFile(remoteIP_str, fileName_str):
...
def senderBinFile(fileName_str, remoteIP_str, port):
    """
...
def begin(in_parameter, remoteIP_str, fileName_str = ""):
    '''Driver function'''
    print("\t Welcome to the chat program:")
    print("\t My IP is: ",getMyIP())
    print("\t Remote IP is: ",remoteIP_str)

    if in_parameter.lower() == "s":
        #print("\t sender()")
        sender(remoteIP_str)

    elif in_parameter.lower() == "r":
        #print("\t receiver()")
        receiver()

    elif in_parameter.lower() == "sf":
        #print("\t senderFile()")
        senderFile(remoteIP_str, fileName_str)

    elif in_parameter.lower() == "rf":
        #print("\t receiverFile()")
        receiverFile()

    elif in_parameter.lower() == "rbf":
        #print("\t receiverBinFile()")
        receiverBinFile()

    elif in_parameter.lower() == "sbf":
        #print("\t senderBinFile(fileName_str, remoteIP_str, port)")
        senderBinFile(fileName_str, remoteIP_str, port)
